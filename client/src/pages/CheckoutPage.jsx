  ...
  if (cartItems.length === 0) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        ...
        <h2 className="text-2xl font-bold mb-4 text-blue-900">Your Cart is Empty</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <div className="bg-white rounded-xl shadow-md p-6 mb-6">
            <h2 className="text-xl font-semibold mb-4 text-blue-800">Your Cart</h2>
                  ...
                  <div className="flex items-center">
                    <div className="mr-4">
                      ...
                      <input
                        ...
                        className="w-16 px-2 py-1 border border-gray-300 rounded-md pl-3 text-blue-900"
                      />
                    </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <form onSubmit={handleSubmitOrder}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="form-input pl-3 border-blue-600 focus:ring-blue-600"
                      required
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="form-input mb-2 pl-3 border-blue-600 focus:ring-blue-600"
              ...
              <button
                type="submit"
                className="bg-blue-600 text-white w-full mt-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition"
                disabled={loading}
              >
