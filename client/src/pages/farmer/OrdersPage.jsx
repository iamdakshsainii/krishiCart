...
const OrdersPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-blue-900">Manage Orders</h1>
      ...
      {filteredOrders.length > 0 ? (
        ...
        <div className="text-center py-12 glass rounded-xl">
          <FaShoppingBasket className="text-blue-600 text-5xl mx-auto mb-4" />
          <h3 className="text-xl font-semibold mb-2 text-blue-900">No Orders Found</h3>
      ...
      {showStatusModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            <h3 className="text-xl font-bold mb-4 text-blue-900">Update Order Status</h3>
            ...
            <div className="mb-4">
              ...
              <select
                ...
                className="form-input border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-600 focus:border-blue-600 w-full"
              >
