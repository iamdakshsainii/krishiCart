...
const AddProductPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="glass p-6 rounded-xl bg-white shadow">
        <h1 className="text-3xl font-bold mb-6 text-blue-900">Add New Product</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <input
                ...
                } pl-3 focus:ring-blue-600 focus:border-blue-600`}
                required
              />
              {errors.name && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className={`form-input ${
                  errors.unit ? "border-red-500" : "border-blue-200"
                } focus:ring-blue-600 focus:border-blue-600`}
                required
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`form-input ${
                  errors.quantityAvailable ? "border-red-500" : "border-blue-200"
                } pl-3 focus:ring-blue-600 focus:border-blue-600`}
                min="0"
                required
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="form-input pl-3 border-blue-200 focus:ring-blue-600 focus:border-blue-600"
              />
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center space-x-4">
              <label className="cursor-pointer bg-white border border-blue-200 rounded-lg px-4 py-2 hover:bg-blue-50 transition">
          ...
          <div className="flex justify-end space-x-4">
            <Link
              to="/farmer/products"
              className="px-6 py-2 border border-blue-200 rounded-lg text-blue-800 hover:bg-blue-50 transition"
            >
              Cancel
            </Link>
            <button
