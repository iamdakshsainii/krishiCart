...
// const CATEGORIES = [
//   { key: "general", label: "General News", icon: Globe, color: "from-blue-500 to-blue-600" },
//   { key: "agriculture", label: "Agriculture", icon: Globe, color: "from-green-500 to-green-600" },
//   { key: "weather", label: "Weather", icon: Calendar, color: "from-sky-500 to-sky-600" },
//   { key: "market", label: "Market", icon: TrendingUp, color: "from-blue-600 to-indigo-600" },
//   { key: "technology", label: "Technology", icon: BarChart3, color: "from-indigo-500 to-purple-600" },
//   { key: "business", label: "Business", icon: Grid, color: "from-blue-700 to-blue-800" },
// ];
...
// // Enhanced News Card Component with White & Blue Theme
...
//   if (viewMode === 'list') {
//     return (
//       <div className="group flex gap-4 bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-blue-200">
...
//                 className={`flex items-center gap-1 px-2 py-1 rounded-lg transition-all ${liked ? 'text-red-500 bg-red-50' : 'text-gray-500 hover:text-red-500'}`}
//               >
...
//                 className={`flex items-center gap-1 px-2 py-1 rounded-lg transition-all ${isBookmarked ? 'text-blue-500 bg-blue-50' : 'text-gray-500 hover:text-blue-500'}`}
//               >
...
//               className="px-3 py-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg text-xs font-medium hover:from-blue-600 hover:to-blue-700 transition-all"
//             >
//               Read More
//             </button>
//           </div>
...
//   return (
//     <article className="group relative bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-500 overflow-hidden cursor-pointer border border-gray-100 hover:border-blue-200 hover:-translate-y-1 transform-gpu">
...
//         <div className={`w-full h-48 bg-gradient-to-br ${getCategoryColor(article.category)} ${!imageLoaded ? 'animate-pulse' : ''}`}>
//           <img
//             src={imageUrl}
//             alt={article.title}
...
//           <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${getCategoryColor(article.category)} text-white shadow-sm backdrop-blur-sm border border-white/20`}>
//             {article.source?.name || 'News'}
//           </span>
//           <div className="flex items-center gap-1 px-2 py-1 bg-white/20 backdrop-blur-md rounded-lg text-white text-xs">
//             <Clock size={10} />
//             {readTime} min read
//           </div>
//         </div>
...
//           <button
//             className="p-2 rounded-full bg-white/90 backdrop-blur-sm shadow-sm hover:bg-white hover:scale-110 transition-all duration-200"
//             onClick={(e) => {
//               e.stopPropagation();
//               handleShare();
//             }}
...
//         <h3 className="text-lg font-semibold text-gray-900 line-clamp-2 leading-tight group-hover:text-blue-600 transition-all duration-300">
//           {article.title}
//         </h3>
...
//               onClick={handleBookmark}
//               className={`flex items-center gap-2 px-3 py-2 rounded-xl transition-all duration-300 hover:scale-105 ${
//                 isBookmarked ? "bg-blue-50 text-blue-500" : "bg-gray-50 text-gray-500 hover:text-blue-500"
//               }`}
//             >
...
//             className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl font-medium text-sm shadow-sm hover:shadow-md transition-all duration-300"
//           >
//             Read More
...
//       {/* Header */}
//       <header className="relative overflow-hidden bg-white/80 backdrop-blur-sm border-b border-blue-100">
...
//               <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 bg-clip-text text-transparent">
//                 KrishiCart News
//               </h1>
//               <p className="text-gray-600 text-lg">
//                 Latest agricultural news and insights from India
//               </p>
//             </div>
...
//                 className="p-3 rounded-xl bg-white border border-gray-200 text-gray-600 hover:border-blue-300 transition-all duration-300"
...
//               className="w-full pl-12 pr-32 py-4 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-100 text-lg transition-all duration-300"
//             />
...
//                   showAdvancedFilter ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-500'
//                 }`}
//               >
//                 <Filter size={20} />
//               </button>
...
//                   className="w-full p-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-blue-400"
//                 >
...
//         <button
//           onClick={handleRefresh}
//           className={`p-4 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg hover:scale-110 transition-all duration-300 ${loading ? 'animate-pulse' : ''}`}
//           title="Refresh news"
//         >
